    ...
    function substituteIndic ($earr, $lang, $font)
    {
        ...
        if ($lang != 'hi')
        {
            $vstr = str_replace('0964', '007C', $vstr); // U+0964 replace with
                                                       // "|"
            $vstr = str_replace('0965', '007C 007C', $vstr); // U+0964 replace
                                                            // with "|"
        }
        // ============================
        ...
        if ($lang == 'ta')
        {
            $vstr = str_replace('0BE6', '0030', $vstr); // U+0BEB replace with
                                                       // "0"
        }
        ...
        if ($lang == 'hi')
        {
            ...
            $nukta = "093C";
            $halant = "094D";
            $vstr = preg_replace('/([A-F0-9]{4}) ' . $prebasedvowels . '/', 
                    '\\2 \\1', $vstr); // vowel
                                                                                                  // sign
                                                                                                  // pre-based
                                                                                                  // shift
                                                                                                  // left
            $vstr = preg_replace(
                    '/([A-F0-9]{4}) ' . $prebasedvowels . ' ' . $nukta . '/', 
                    '\\2 \\1 ' . $nukta, $vstr); // before
                                                                                                                     // NUKTA
            $vstr = preg_replace(
                    '/([A-F0-9]{4}) ' . $halant . ' ' . $prebasedvowels . '/', 
                    '\\2 \\1 ' . $halant, $vstr); // before
                                                                                                                       // CHAR
                                                                                                                       // HALANT
                                                                                                                       // ==
                                                                                                                       // VIRAMA
        ...
        // BENGALI vowels [09BF 09C7 09C8]
            ...
            if ($lang == 'bn')
            {
                ...
                $vstr = preg_replace('/09CE/', '09A4 09CD 200D', $vstr); // mPDF
                                                                        // 5.3.09
                                                                        
                // BENGALI double-part vowels [09CB 09C7 09BE][09CC 09C7 09D7]
                $vstr = str_replace('09CB', '09C7 09BE', $vstr); // convert to 2
                                                                // parts
                $vstr = str_replace('09CC', '09C7 09D7', $vstr); // 09C7
                                                                // pre-based is
                                                                // then shifted
                                                                // below
                ...
                $vstr = preg_replace(
                        '/(' . $bnfullcons . ') ' . $halant . ' ' .
                                 $prebasedvowels . '/', '\\2 \\1 ' . $halant, 
                                $vstr);
                
                // mPDF 5.0.044
                // If left-based vowel has now been shifted to left of RA/Halant
                // (09B0/09CD)
                // Convert here to above-line form (E068) as it would get missed
                // later
                ...
                $vstr = preg_replace('/(09C7|09C8) 09B0 09CD/', '\\1 E068', 
                        $vstr);
            }
            ...
            // GUJARATI pre-based vowel [0ABF]
                ...
                // GURMUKHI/PUNJABI pre-based vowel [0ABF]
                    ...
                    // TAMIL pre-based vowel [0ABF]
                        ...
                        {
                            // Shrii (Shree)
                            $vstr = preg_replace('/0BB6 0BCD 0BB0 0BC0/', 
                                    'E04B', $vstr);
                            
                            // TAMIL double-part vowels [0BCA 0BC6 0BBE][0BCB
                            // 0BC7 0BBE][0BCC 0BC6 0BD7]
                            $vstr = preg_replace('/0BCA/', '0BC6 0BBE', $vstr); // convert
                                                                               // to
                                                                               // 2
                                                                               // parts
                            $vstr = preg_replace('/0BCB/', '0BC7 0BBE', $vstr); // pre-based
                                                                               // is
                                                                               // then
                                                                               // shifted
                                                                               // below
                            ...
                            // No nukta
                            $halant = "0BCD"; // Doesn't seem to move most in
                                              // front of halanted consonants
                            $vstr = preg_replace(
                                    '/([A-F0-9]{4}) ' . $prebasedvowels . '/', 
                                    '\\2 \\1', $vstr); // vowel
                                                                                                                  // sign
                        ...
                        // ORIYA
                            ...
                            if ($lang == 'or')
                            {
                                ...
                                $vstr = str_replace('0B48', '0B47 0B56', $vstr); // 2-part
                                                                                // Vowel
                                $vstr = str_replace('0B4B', '0B47 0B3E', $vstr); // 2-part
                                                                                // Vowel
                                $vstr = str_replace('0B4C', '0B47 0B57', $vstr); // 2-part
                                                                                // Vowel
                                $orprebasedvowels = "(0B47)";
                                // No nukta
                                $halant = "0B4D";
                                $vstr = preg_replace(
                                        '/([A-F0-9]{4}) ' . $orprebasedvowels .
                                                 '/', '\\2 \\1', $vstr); // vowel
                                                                                                                                // sign
                                                                                                                                // pre-based
                                                                                                                                // shift
                            ...
                            // MALAYALAM
                                ...
                                if ($lang == 'ml')
                                {
                                    ...
                                    // This font Volt rules recognises e.g. "Na
                                    // Halant(Virama)" as ChilluN
                                    $vstr = preg_replace(
                                            '/(0D23 0D4D|0D28 0D4D|0D30 0D4D|0D32 0D4D|0D33 0D4D) 200D/', 
                                            '\\1', $vstr);
                                    // See Chillus in Unicode
                                    // [http://en.wikipedia.org/wiki/Malayalam_script]
                                    $vstr = str_replace('0D7A', '0D23 0D4D', 
                                            $vstr); // [mlymChilluNn]
                                    $vstr = str_replace('0D7B', '0D28 0D4D', 
                                            $vstr); // [mlymChilluN]
                                    $vstr = str_replace('0D7C', '0D30 0D4D', 
                                            $vstr); // [mlymChilluR]
                                    $vstr = str_replace('0D7D', '0D32 0D4D', 
                                            $vstr); // [mlymChilluL]
                                    $vstr = str_replace('0D7E', '0D33 0D4D', 
                                            $vstr); // [mlymChilluLl]
                                    /*
                                     * // Chillus - 0D7A-0D7E not in font
                                     * directly, but as E005-E009 $vstr =
                                     * preg_replace('/0D23 0D4D 200D/','0D7A',
                                     * $vstr); $vstr = preg_replace('/0D28 0D4D
                                     * 200D/','0D7B', $vstr); $vstr =
                                     * preg_replace('/0D30 0D4D 200D/','0D7C',
                                     * $vstr); $vstr = preg_replace('/0D32 0D4D
                                     * 200D/','0D7D', $vstr); $vstr =
                                     * preg_replace('/0D33 0D4D 200D/','0D7E',
                                     * $vstr); $vstr =
                                     * preg_replace('/0D7F/','E004', $vstr);	//
                                     * [mlymChilluK] $vstr =
                                     * preg_replace('/0D7A/','E005', $vstr);	//
                                     * [mlymChilluNn] $vstr =
                                     * preg_replace('/0D7B/','E006', $vstr);	//
                                     * [mlymChilluN] $vstr =
                                     * preg_replace('/0D7C/','E007', $vstr);	//
                                     * [mlymChilluR] $vstr =
                                     * preg_replace('/0D7D/','E008', $vstr);	//
                                     * [mlymChilluL] $vstr =
                                     * preg_replace('/0D7E/','E009', $vstr);	//
                                     * [mlymChilluLl]
                                     */
                                    
                                    // MALAYALAM double-part vowels []
                                    $vstr = str_replace('0D4A', '0D46 0D3E', 
                                            $vstr); // 2-part
                                                                                            // Vowel
                                    $vstr = str_replace('0D4B', '0D47 0D3E', 
                                            $vstr); // 2-part
                                                                                            // Vowel
                                    $vstr = str_replace('0D4C', '0D46 0D57', 
                                            $vstr); // 2-part
                                                                                            // Vowel
                                ...
                                // TELUGU
                                    ...
                                    if ($lang == 'te')
                                    {
                                        // TELUGU double-part vowels [0C48 ->
                                        // 0C46 0C56]
                                        $vstr = str_replace('0C48', '0C46 0C56', 
                                                $vstr); // 2-part
                                                                                                // Vowel
                                        $prebasedvowels = "(0C46)";
                                    ...
                                    // KANNADA
                                        ...
                                        if ($lang == 'kn')
                                        {
                                            // KANNADA double-part vowels [0CC8
                                            // -> 0CC6 0CD6]
                                            $vstr = str_replace('0CC0', 
                                                    '0CBF 0CD5', $vstr); // 2-part
                                                                                                    // Vowel
                                            $vstr = str_replace('0CC7', 
                                                    '0CC6 0CD5', $vstr); // 2-part
                                                                                                    // Vowel
                                            $vstr = str_replace('0CC8', 
                                                    '0CC6 0CD6', $vstr); // 2-part
                                                                                                    // Vowel
                                                                                                    // AI
                                                                                                    // -
                                                                                                    // no
                                                                                                    ...
                                                                                                    // for
                                                                                                    // single
                                            $vstr = str_replace('0CCA', 
                                                    '0CC6 0CC2', $vstr); // 2-part
                                                                                                    // Vowel
                                            $vstr = str_replace('0CCB', 
                                                    '0CC6 0CC2 0CD5', $vstr); // 2-part
                                                                                                         // Vowel
        ...
        if ($lang == 'hi')
        {
            $vstr = str_replace('0930 094D 0930', 'E05D 0930', $vstr); // Ra
                                                                      // Halant
                                                                      // Ra =>
                                                                      // halfRa
                                                                      // FullRa
        ...
        if ($lang == 'gu')
        {
            $vstr = str_replace('0AB0 0AC2', 'E02E', $vstr); // Ra VowelUu =>
                                                            // SpecialForm RaUu
        }
        
        // TELUGU Ra Halant <Consonant> Halant => halfRa Halant<Consonant>
        // Halant
        if ($lang == 'te')
        {
            $vstr = preg_replace('/0C30 0C4D ([A-F0-9]{4}) 0C4D/', 
                    'E021 0C4D \\1 0C4D', $vstr);
        }
        ...
        if ($lang == 'kn')
        {
            $vstr = str_replace('0CB0 0CCD 0020', 'E0CC 0020', $vstr); // mPDF
                                                                      // 5.3.87
        }
        ...
        {
            // echo $rid . ': ' . $vstr.'<br />';
            $vstr = preg_replace('/' . $reps['match'] . '/', $reps['replace'], 
                    $vstr);
        }
        // echo $vstr.'<br />'; exit;
        ...
        // KANNADA
        // <Base> <BelowBase1> [<BelowBase2> ] MatraI -> <Base/MatraI ligature>
        // <Belowbase1> etc
        if ($lang == 'kn')
        {
            $matraI = "0CBF";
            $knbase = preg_split('/\|/', 
                    "0C95|0C96|0C97|0C98|0C9A|0C9B|0C9C|0C9D|0CA0|0CA1|0CA2|0CA3|0CA4|0CA5|0CA6|0CA7|0CA8|0CAA|0CAB|0CAC|0CAD|0CAE|0CAF|0CB0|0CB2|0CB3|0CB5|0CB6|0CB7|0CB8|0CB9|E0A3|E07D|E07E");
            $knmatraIligature = preg_split('/\|/', 
                    "E082|E083|E084|E085|E086|E087|E088|E089|E08A|E08B|E08C|E08D|E08E|E08F|E090|E091|E092|E093|E094|E095|E096|E097|E098|E099|E09A|E09B|E09C|E09D|E09E|E09F|E0A0|E0A4|E0A1|E0A2");
            ...
            for ($i = 0; $i < count($knbase); $i ++)
            {
                $vstr = preg_replace(
                        '/' . $knbase[$i] . ' (' . $belowbase1 . ') (' .
                                 $belowbase2 . ') ' . $matraI . '/', 
                                $knmatraIligature[$i] . ' \\1 \\2', $vstr);
                $vstr = preg_replace(
                        '/' . $knbase[$i] . ' (' . $belowbase1 . ') ' . $matraI .
                                 '/', $knmatraIligature[$i] . ' \\1', $vstr);
            }
        }
        ...
        if ($lang == 'kn')
        {
            $vstr = preg_replace('/0C9F ' . $matraI . '/', 'E015 ' . $matraI, 
                    $vstr);
        }
        ...
        if ($lang == 'or')
        {
            // SpecialCase Ra[0B30] Halant still left before [oryaFullNnNna] =>
            // E00F
            $vstr = preg_replace('/0B30 ' . $halant . ' E00F/', 'E00F E069', 
                    $vstr); // convert
                                                                                        // to
                                                                                        // Reph
        }
        ...
        if ($lang == 'hi')
        {
            ...
            $vstr = preg_replace(
                    '/E05D (' . $himatchhalfforms . '|' . $himatchfullforms .
                             ')/', 'E015 \\1', $vstr);
            ...
            {
                $vstr = preg_replace('/E015 (' . $himatchhalfforms . ')/', 
                        '\\1 E015', $vstr);
            }
            $vstr = preg_replace('/E015 (' . $himatchfullforms . ')/', 
                    '\\1 E015', $vstr);
            
            // Now shift it beyond post-based vowels // ??? Need to add others
            // e.g. 0949,094A,094B,094C + presentation forms like E198
            $vstr = str_replace('E015 093E', '093E E015', $vstr);
            $vstr = preg_replace('/E015 (0940|E194|E195|E196|E197|E198)/', 
                    '\\1 E014', $vstr); // (Small)
                                                                                                       // reph
                                                                                                       // [E014]
                                                                                                       // to
                                                                                                       ...
                                                                                                       // of
                                                                                                       // matraI
            $vstr = str_replace('E015 0947', '0947 E014', $vstr); // (Small)
                                                                  // reph [E014]
                                                                  // to Right of
                                                                  // matraI
        }
        ...
        // BENGALI Shift Reph [E068]
            ...
            if ($lang == 'bn')
            {
                ...
                $vstr = preg_replace(
                        '/E068 (' . $bnfullconjuncts . '|' . $bnfullcons . ')/', 
                        '\\1 E068', $vstr);
                // ? Need to shift it beyond post-base vowels 09BE, 09C0, 09D7
                // haven't found so can't test??
                $vstr = preg_replace('/E068 (09BE|09C0|09D7)/', '\\1 E068', 
                        $vstr);
            }
            ...
            // GUJARATI Shift Reph [E032]
                ...
                if ($lang == 'gu')
                {
                    ...
                    $vstr = preg_replace('/E032 (' . $gufullforms . ')/', 
                            '\\1 E032', $vstr);
                    // Now shift it beyond post-based vowels // ??? Need to add
                    // others e.g. 0949,094A,094B,094C + presentation forms like
                    // E198
                    // ? Need to shift it beyond post-base vowels 0ABE, 0AC0
                    // haven't found so can't test??
                    $vstr = preg_replace('/E032 (0ABE|0AC0)/', '\\1 E032', 
                            $vstr);
                }
                
                // TELUGU Shift Reph to LEFT [E046|E069|E077] [TelRaSmallOne] =>
                // E046 [TelRaSmallTwo] => E069 [TelRaSmallThree] => E077
                else 
                    if ($lang == 'te')
                    {
                        ...
                        $vstr = preg_replace(
                                '/(' . $tevowels . ') (E046|E069|E077)/', 
                                '\\2 \\1', $vstr);
                        while (preg_match(
                                '/(' . $tepartialforms . ') (E046|E069|E077)/', 
                                $vstr))
                        {
                            $vstr = preg_replace(
                                    '/(' . $tepartialforms .
                        ...
                        $vstr = preg_replace(
                                '/(' . $tefullforms . '|' . $matraligs .
                                         ') (E046|E069|E077)/', '\\2 \\1', $vstr);
                    }
                    ...
                    // KANNADA Shift Reph to RIGHT [E00B]
                        ...
                        if ($lang == 'kn')
                        {
                            ...
                            while (preg_match('/E00B (' . $knpartialforms . ')/', 
                                    $vstr))
                            {
                                $vstr = preg_replace(
                                        '/E00B (' . $knpartialforms . ')/', 
                            ...
                            // mPDF 5.3.47 Also move Reph to right of
                            // matraIligatures
                            ...
                            $vstr = preg_replace('/E00B (' . $knfullforms . ')/', 
                                    '\\1 E00B', $vstr);
                            
                            // ? Need to shift it beyond base or below-base
                            // forms - haven't found so can't test??
                            // mPDF 5.3.87
                            // E004 added to list (which is a transformed
                            // version of 0CBE)
                            $knvowels = "0CBE|0CC0|0CC1|0CC2|0CC3|0CC4|0CC7|0CC8|0CCA|0CCB|0CD5|0CD6|E004";
                            $vstr = preg_replace('/E00B (' . $knvowels . ')/', 
                                    '\\1 E00B', $vstr);
                        }
                        ...
                        // ORIYA Shift Reph to RIGHT [E069|E06A|E06B|E06C]
                            ...
                            if ($lang == 'or')
                            {
                                ...
                                // E123 - E147 FullHalant forms ? add to
                                // FullForms
                                $orpartialforms = "E090|E091|E092|E093|E094|E095|E096|E097|E098|E099|E09A|E09B|E09C|E09D|E09E|E09F|E0A0|E0A1|E0A2|E0A3|E0A4|E0A5|E0A6|E0A7|E0A8|E0A9|E0AA|E0AB|E0AC|E0AD|E0AE|E0AF|E0B0|E0B1|E0B2|E0B3|E0B4|E0B5|E0B6|E0B7|E0B8|E0B9|E0BA|E0BB|E0BC|E0BD|E0BE|E0BF|E0C0|E0C1|E0C2|E0C3|E0C4|E0C5|E0C6|E0C7|E0C8|E0C9|E0CA|E0CB|E0CC|E0CD|E0CE|E0CF|E0D0|E0D1|E0D2|E0D3|E0D4|E0D5|E0D6|E0D7|E0D8|E0D9|E0DA|E0DB|E0DC|E0DD|E0DE|E0DF|E0E0|E0E1|E0E2|E0E3|E0E4|E0E5|E0E6|E0E7|E0E8|E0E9|E0EA|E0EB|E0EC|E0ED|E0EE|E0EF|E0F0|E0F1|E0F2|E0F3|E0F4|E0F5";
                                
                                // Combined MatraIReph[E06D] split [0B3F & E069]
                                // to allow reph to be shifted forwards
                                $vstr = preg_replace(
                                        '/(' . $orfullforms . ') E06D (' .
                                                 $orfullforms . ') 0B3E/', 
                                                '\\1 0B3F E069 \\2 0B3E', $vstr);
                                
                                while (preg_match(
                                        '/(' . $orrephs . ') (' . $orpartialforms .
                                                 ')/', $vstr))
                                {
                                    $vstr = preg_replace(
                                            '/(' . $orrephs . ') (' .
                                ...
                                $vstr = str_replace('E069 0B3F', 'E06D', $vstr); // Reph
                                                                                 // and
                                                                                 // MatraI
                                                                                 // ->
                                                                                 // MatraIReph
                                $vstr = str_replace('E06A 0B3F', 'E06E', $vstr); // Reph
                                                                                 // and
                                                                                 // MatraI
                                                                                 // ->
                                                                                 // MatraIReph
                                $vstr = str_replace('E06B 0B3F', 'E06F', $vstr); // Reph
                                                                                 // and
                                                                                 // MatraI
                                                                                 // ->
                                                                                 // MatraIReph
                            ...
                            // MALAYALAM Shift Reph to LEFT [E00E]
                            // (mlylmRaVattu)
                            else 
                                if ($lang == 'ml')
                                {
                                    ...
                                    $vstr = preg_replace(
                                            '/([A-F0-9]{4}) ' . $halant .
                                                     ' 0D30/', 'E00E \\1', $vstr); // 0D30
                                                                                                                                // =
                                                                                                                                // Ra
                                    $vstr = preg_replace(
                                            '/([A-F0-9]{4}) ' . $halant . ' ' .
                                                     $mlprebasedvowels . ' 0D30/', 
                                                    '\\2 E00E \\1', $vstr); // 0D30
                                                                                                                                                           // =
                                                                                                                                                           // Ra
        ...
        // SHIFT post-based vowels to Left of SmallForms (NOT to left of full
        // forms)
        ...
        if ($lang == 'te')
        {
            ...
            $vstr = preg_replace('/(' . $tebelowbase2 . ') (' . $tevowels . ')/', 
                    '\\2 \\1', $vstr);
            $vstr = preg_replace('/(' . $tebelowbase1 . ') (' . $tevowels . ')/', 
                    '\\2 \\1', $vstr);
        }
        ...
        // KANNADA Shift
            ...
            if ($lang == 'kn')
            {
                $knvowels = "0CBE|0CC0|0CC1|0CC2|0CC3|0CC4|0CC7|0CC8|0CCA|0CCB|0CD5|0CD6" .
                        // mPDF 5.3.87 Shouldn't swop E082 and E047 (belowbase1)
                        // below
                ...
                $vstr = preg_replace('/(' . $belowbase2 . ') (' . $knvowels .
                         ')/', '\\2 \\1', $vstr);
                // mPDF 5.3.87
                $vstr = preg_replace('/(' . $belowbase1 . ') (' . $knvowels .
                         ')/', '\\2 \\1', $vstr);
                
                // $vstr = preg_replace('/('.$fullforms.') ('.$knvowels.')/',
            // '\\2 \\1', $vstr);
            }
