...
$mpdf->useAdobeCJK = true; // Default setting in config.php
                           // You can set this to false if you have defined
                           // other CJK fonts

$mpdf->SetAutoFont(AUTOFONT_ALL); // AUTOFONT_CJK | AUTOFONT_THAIVIET |
                                  // AUTOFONT_RTL | AUTOFONT_INDIC //
                                  // AUTOFONT_ALL
                                  // () = default ALL, 0 turns OFF (default
                                  // initially)
